...
public class FuerzaGravitacional : MonoBehaviour
{
    [SerializeField]
    ...
    void Awake()
    {
        masaA = masaAjena.GetComponent<FuerzaGravitacional>().mass;
    ...
    private Vector3 FuerzaG(float masaA, Vector3 r)
    {
